...
import com.example.flutter_lebo.FlutterLeboPlugin
import kotlin.properties.ReadWriteProperty
import kotlin.reflect.KProperty

class SharedPreference<T>(val name: String, val default: T) {

    val prefs: SharedPreferences by lazy { FlutterLeboPlugin.ctx!!.getSharedPreferences(name, Context.MODE_PRIVATE) }
